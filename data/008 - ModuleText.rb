...
module RPG
  class Text
    ...
    attr_accessor :stone_full_bag           # 石料背包满
    ...
    attr_accessor :sp_used
    attr_accessor :sp_no_lv
    attr_accessor :sp_no_match
    attr_accessor :sp_no_fp2
    attr_accessor :sp_is_cd
    attr_accessor :self_is_busy
    attr_accessor :aim_is_busy
    attr_accessor :aim_is_busy2
    attr_accessor :sp_no_attr
    attr_accessor :magic_net
    attr_accessor :fly_no_fp
    attr_accessor :shop_info
    attr_accessor :shop_info2
    attr_accessor :shop_number
    attr_accessor :cannot_move
    attr_accessor :battle_item
    attr_accessor :die_msg
